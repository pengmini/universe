...
export const TOPICS = [
  ...
  },
  {
    ...
    hint: "단소를 연습할 때 나를 도와준 친구를 눌러 고마움을 전해요",
    placeholder: "",
    css: "#A276E8", mix: ["#241442", "#A276E8", "#D46FC8", "#6A4BBF"]
  },
];

/* ④ 단소 도움 명단. 학급 명단 등록 화면이 아직 없어서(다음 단계) 코드에 둡니다.
   실제 명단으로 바꾸려면 이 배열만 고치면 됩니다. 학생 화면의 「단소 도움」 탭에
   이 이름들로 버튼이 뜨고, 버튼을 누르면 그 친구가 도와준 횟수가 하나 늘어납니다. */
export const ROSTER = [
  "서연","민준","지우","하윤","도윤","예준","시우","서준","하은","지호",
